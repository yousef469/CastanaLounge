          ...
          <div className="mt-8 pt-6 border-t border-[#d4af37]/20 print:hidden">
            ...
            <div className="flex justify-center items-center gap-4 mb-4">
              ...
              <div className="flex flex-col items-center gap-2 group">
                <div className="p-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl shadow-lg shadow-purple-500/20 transition-all">
              ...
              {/* Facebook */}
              <div className="flex flex-col items-center gap-2 group">
                <div className="p-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg shadow-blue-500/20 transition-all">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">

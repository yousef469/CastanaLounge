...
const featuredProducts = [
  ...
  },
  {
    id: 'coffee',
    nameAr: 'قهوة كستانا',
    nameEn: 'Castana Coffee',
    price: 18,
    descriptionAr: 'قهوة عربية أصيلة محضرة بأجود حبوب البن، تقدم مع تمر فرش.',
    descriptionEn: 'Authentic Arabic coffee made with premium coffee beans, served with fresh dates.',
